...
const projects = [
  ...
  /* ── UI Design ────────────────────────────────────────────── */
  {
    ...
    cover: 'images/ch-09.jpg',
    images: [
      { src: 'images/ch-09.jpg',  caption: '' },
      { src: 'images/ch-10.jpg',  caption: '' },
      { src: 'images/ch-01.png',  caption: '痛點與解決' },
      ...
      { src: 'images/ch-02.png',  caption: '完整設計全覽 — 頁面整合展示。' },
      { src: 'images/ch-06.png',  caption: '網站框架設定' },
      { src: 'images/ch-03.png',  caption: 'Design Token' },
      { src: 'images/ch-05.png',  caption: 'BTN' },
      { src: 'images/ch-04.png',  caption: 'Component' },
      { src: 'images/ch-07.png',  caption: 'Wireframe' }
    ],
  ...
  },
  {
    ...
    categoryLabel: 'UI Design System',
    tool: 'Figma · Wireframe · Prototype',
    cover: 'images/lb-02.png',
    images: [
      { src: 'images/lb-02.png',  caption: '' },
      { src: 'images/lb-09.jpg',  caption: '' },
      { src: 'images/lb-10.jpg',  caption: '' },
      { src: 'images/lb-01.png',  caption: '痛點與解決' },
      ...
      { src: 'images/lb-06.png',  caption: '頁面框架設定' },
      { src: 'images/lb-03.png',  caption: 'Design Token' },
      { src: 'images/lb-05.png',  caption: 'BTN' },
      { src: 'images/lb-04.png',  caption: 'Component' },
      { src: 'images/lb-07.png',  caption: 'Wireframe' }
    ],
  ...
  },
  {
    ...
    cover: 'images/tt-02.png',
    images: [
      { src: 'images/tt-02.png',  caption: '' },
      { src: 'images/tt-09.jpg',  caption: '' },
      { src: 'images/tt-10.jpg',  caption: '' },
      { src: 'images/tt-11.jpg',  caption: '' },
      { src: 'images/tt-01.png',  caption: '痛點與解決' },
      ...
      { src: 'images/tt-07.png',  caption: '完整設計全覽 — 頁面整合展示。' },
      { src: 'images/tt-06.png',  caption: 'APP 框架設定' },
      { src: 'images/tt-03.png',  caption: 'Design Token' },
      { src: 'images/tt-05.png',  caption: 'BTN' },
      { src: 'images/tt-04.png',  caption: 'Component' }
    ],
